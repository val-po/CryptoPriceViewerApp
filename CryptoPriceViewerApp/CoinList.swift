//
//  ContentView.swift
//  CryptoPriceViewerApp
//
//  Created by valentine on 09.01.2022.
//
...
struct CoinList: View {
    ...
    var body: some View {
        NavigationView {
            List(viewModel.coinViewModels, id: \.self) { coinViewModel in Text (coinViewModel.displayText)
            }.onAppear {
...
class CoinListViewModel: ObservableObject {
    ...
    func fetchCoins() {
        ...
        }, receiveValue: { cryptoContiner in
            self.coinViewModels = cryptoContiner.data.coins.map {
                CoinViewModel($0)
            }
